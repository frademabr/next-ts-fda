...
export const pageLinks = [
  ...
  },
  {
    ...
    items: [
      { title: "Landing", path: paths.servicos.root },
      { title: "Courses", path: paths.servicos.courses },
      { title: "Course", path: paths.servicos.course },
      { title: "Posts", path: paths.servicos.posts },
      { title: "Post", path: paths.servicos.post },
      { title: "About", path: paths.servicos.about },
      { title: "Contact", path: paths.servicos.contact },
    ],
  },
  {
...
export const navData = [
  ...
  { title: "Serviços", path: paths.servicos.courses },
